...
class CrossEncoderReranker:
    ...
    def rerank(self, query: str, documents: list[dict], top_k: int = RERANK_TOP_K) -> list[RerankResult]:
        ...
        return [RerankResult(text=doc["text"], original_score=doc.get("score", 0.0), rerank_score=float(score), metadata=doc["metadata"], rank=i) for i, (score, doc) in enumerate(scored[:top_k])]
